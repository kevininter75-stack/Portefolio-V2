...
// Composant Originkit « Scramble Text » (https://www.originkit.dev/components/scrambletext),
// récupéré via le connecteur et adapté Next.js/TS. Révélation au scroll + diffusion au survol.
// Autonome, zéro dépendance. Export par défaut : GlitchCharReveal.
